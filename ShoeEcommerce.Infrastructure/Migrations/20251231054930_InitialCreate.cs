        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplacementToken = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RevokedByAdminId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBlocks_Users_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserBlocks_Users_RevokedByAdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBlocks_AdminId",
                table: "UserBlocks",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBlocks_RevokedByAdminId",
                table: "UserBlocks",
